> **Multilingual Publication Notice:** This document is dual-published in Korean and English. v3.4 2026-09-13 (Korean Version: [README.ko.md](README.ko.md))  
> **Original Authority Notice:** The authoritative legal and engineering standard for this technical specification belongs strictly to the Korean original (`README.ko.md`), while English and other translations function solely for secondary reference. (PHILOSOPHY.ko.md is authoritative original)

# CWP-Entry v3.4 - Guidance and Position Alignment System (Universal Track & Railless Mobility Integrated Expansion)

* **Official Document Classification:** Defensive Publication / Prior Art White Paper
* **Publication Date:** 2026-09-13 (first draft 2026-08-20, v0.2.1 2026-08-22, v3.0 2026-08-22, v3.3 2026-08-23, v3.4 2026-09-13)
...
* **Search Keywords:** CWP, CWP-Entry, EV Battery Swap, Railway Bogie Alignment, Tunnel Mobility Guidance, Entry Guidance, Position Alignment, V-Rail, U-Rail, Guide Groove, Railless Wheel Guide, Roller Guide, Line Laser, 0.1ms HW Intercept, Minimal Infra Retrofit, Quiet Assist, Fail-Safe, Selective Passage, Rail & Railless Mobility Alignment, Prior Art
...
## 1. Overview
CWP-Entry is a universal system for entry guidance and position alignment across transport environments, including EV battery swapping as well as **railway rolling stock, large-scale mobility inside tunnels, logistics track systems, and railless ground guide environments**.  
**Unlike conventional top-down descending or large vehicle lift systems, this system adopts a bottom-up V/U-rail and guide groove-based ascending docking approach, aiming for infrastructure implementation without massive floor excavation work.**  
It is configured to achieve precision alignment guidance within ±2mm through a 3-stage alignment sequence (Guide -> Entry -> V-Home) combining upper line lasers and lower rail/guide groove integration.

---

## 2. Background & Minimal Infra Retrofit

* **Minimal Infra Retrofit:** Instead of constructing expensive proprietary robotic facilities from scratch or extensively renovating flooring, this system universally adopts and reuses existing V-rails, chain transport mechanisms, and guide rails from national gas stations, parking lots, automated car washes, **as well as railway maintenance depots, underground tunnels, and logistics floor surfaces**. 5cm (SLIM), 8cm (SHUTTLE), and heavy-duty modular units are retrofitted onto existing infrastructure surfaces with minimal modifications to reduce initial setup costs and establish hubs.
...
* **Entry Guidance & Primary Alignment (`CWP-Entry` - This Technology):** Mitigates mobility entry errors and precisely guides vehicles/mobility to maintenance/inspection zones via car wash, railway/tunnel common V/U-rail, ground guide groove adoption, and line laser guides.
...
* **FIG. 1**: Overall isometric view of the CWP-Entry autonomous guidance and alignment system
  ...
  * Lower secondary alignment via V/U-rail guide channels, ground-embedded grooves, and chain/traction mechanisms (covering railway bogie, tunnel transport, and railless wheel guide structures)
...
<img width="4000" height="8238" alt="CWP-Entry_BOX_TYPE_PREVIEW_4K" src="https://github.com/user-attachments/assets/b30710f4-e03a-49ce-86e4-3c604b6fdcae" />
...
### 6.2 Universal Mobility & Off-Rail / Railless Extension
* **Form-Factor Agnostic:** Scalable beyond passenger EVs to **railway rolling stock (electric train/locomotive bogie alignment), special transport mobility inside tunnels, UAM/drone landing sites, logistics AGVs/AMRs, micro-mobility, special exploration rovers, and in-orbit module and heavy payload alignment structures**.
* **Physical Rail Media Non-Limitation:** This guidance mechanism is not limited to raised metallic rail structures, but comprehensively applies to all entry guidance structures where physical or optical trajectory guidance means exist, including floor-embedded V/U guide grooves, unpowered roller guides, railless road wheel guide bumps, and autonomous transport optical guide lines.
...
* **Selective Passage Linkage (Rail & Railless Commonality):** Implements entry/exit traffic flows by reusing existing automated car wash, railway shunting line, tunnel running rail, and logistics guide infrastructure without adding new dedicated robotic infrastructure, adhering to the Minimal Infra Retrofit principle.
  * **Swap/Maintenance-Utilizing Mobility:** Naturally enters existing rail/guide lines after task completion to perform subsequent processes.
...
* **Existing Infrastructure & Fleet Linkage:** Can be deployed identically in ground transport infrastructure of gas stations, charging stations, railway depots, underground tunnel management posts, and logistics pallet floor transport hubs.
...
* **Scope Comprehensiveness:** Rail specifications, sensor parameters, entry error figures, transport modes, and lineups described in this document are not limited to specific rails or car washes, but comprehensively apply to **all rail- and railless-based guidance transport infrastructure—such as raised rails, embedded guide grooves, railless wheel guide bumps, unpowered rollers, and optical guide lines**—as superior concepts to preempt prior art.
...
* **deundeuni (System Architect & Sole Inventor):** General planner and sole inventor of the CWP-Entry system architecture, V/U-rail alignment parameters, extension mechanisms for large-scale rail infrastructure (railways, tunnels) and railless ground guides, 0.1ms HW Intercept, and Minimal Retrofit structures described in this specification (Conception & Structural Design).
* **Software Utility Notice:** Software and AI tools used during the preparation of this document were limited to **Passive Execution Utilities** performing drafting, document organization, formatting, and review based on the conception and design direction provided by the designer, independent of specific brand or model names, and do not affect the proprietary design know-how, core logic, or inventorship of this system.
